import{j as o}from"./jsx-runtime-BjG_zV1W.js";import{c as h}from"./index-CRGxjvZy.js";const d=h("relative inline-block h-6 w-6 text-[color:var(--color-neutral-icon-default)]",{variants:{size:{24:"h-6 w-6"},tone:{neutral:"text-[color:var(--color-neutral-icon-default)]",accented:"text-[color:var(--color-accented-icon-interactive)]"}},defaultVariants:{size:"24",tone:"neutral"}}),w={star:e=>`<svg preserveAspectRatio="none" width="100%" height="100%" overflow="visible" style="display: block;" viewBox="0 0 20 19" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <path id="vector" d="M6.55 16.2L11.725 10H7.725L8.45 4.325L3.825 11H7.3L6.55 16.2ZM4 20L5 13H0L9 0H11L10 8H16L6 20H4Z" fill="${e??"currentColor"}"/></svg>`},r=({ref:e,className:a,color:t,glyph:l="bolt",size:i,style:n,...s})=>{const c=t?{...n,color:t}:n,v={star:"absolute inset-[8.33%_8.33%_12.5%_8.33%]",like:"absolute inset-[11.04%_8.33%_12.5%_8.33%]",check:"absolute bottom-1/4 left-[16.04%] right-[16.04%] top-[24.9%]",arrowDown:"absolute inset-[41.67%_29.17%_37.5%_29.17%]",arrowUp:"absolute inset-[37.5%_29.17%_41.67%_29.17%]",clear:"absolute inset-[16.67%_8.33%]",bolt:"absolute inset-[8.33%_16.67%]"}[l],p=w[l](t);return o.jsx("span",{ref:e,className:d({className:a,size:i}),style:c,"data-testid":"Icon","aria-hidden":"true",...s,children:o.jsx("span",{className:"pointer-events-none absolute left-0 top-0 h-full w-full",children:o.jsx("span",{className:v,children:o.jsx("span",{className:"block size-full",dangerouslySetInnerHTML:{__html:p}})})})})};r.displayName="Icon";r.__docgenInfo={description:`Icon component renders a fixed 24×24 container with an inline SVG glyph.
...
\`\`\``}},composes:["Omit","VariantProps"]};export{r as I};
